...
def train_models():
    ...
    try:
        # Load the dataset
        data = pd.read_csv(
            "C:\\Users\\acer\\Downloads\\twitter_racism_parsed_dataset.csv"
        )
...
# After computing lr_accuracy, svm_accuracy, rfc_accuracy in train_models():
import matplotlib.pyplot as plt


def plot_accuracies():
    models = ["Logistic Regression", "SVM", "Random Forest"]
    accuracies = [lr_accuracy, svm_accuracy, rfc_accuracy]
...
# Call this at the end of train_models(), just before enabling the Predict button:
plot_accuracies()
